...
export { PositionSizeSectionComponent } from './lib/editor/inspector/sections/position-size-section.component';
export { PageSectionComponent } from './lib/editor/inspector/sections/page-section.component';
...
// Phase E additions
export { FloatingActionToolbarComponent } from './lib/editor/canvas-overlay/floating-action-toolbar.component';
export { ImageSectionComponent, FOCAL_POINT_POSITIONS } from './lib/editor/inspector/sections/image-section.component';
export { EffectsSectionComponent, SHADOW_PRESETS, type ShadowPreset } from './lib/editor/inspector/sections/effects-section.component';
...
export { TypographySectionComponent, SYSTEM_FONTS, type TextAlign } from './lib/editor/inspector/sections/typography-section.component';
